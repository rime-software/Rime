...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Rime\ActionDispatch\Route', $actual);
    }
    ...
    public function testAddAndGenerate()
    {
        ...
        // fail to match
        $this->setExpectedException('\Rime\ActionDispatch\Exception\RouteNotFound');
    ...
    public function testGetAndSetRoutes()
    {
        ...
        $this->assertInstanceOf('\Rime\ActionDispatch\RouteCollection', $actual);
        $this->assertTrue(count($actual) == 2);
        $this->assertInstanceOf('\Rime\ActionDispatch\Route', $actual['page.browse']);
    ...
    public function testArrayAccess()
    {
        ...
        $this->setExpectedException('\Rime\ActionDispatch\Exception\UnexpectedValue');
