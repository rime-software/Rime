...
class ViewTest extends \PHPUnit_Framework_TestCase
{
  ...
  {
    $this->assertInstanceOf('Rime\ActionView\TemplateRegistry', $this->view->getViewRegistry());
    $this->assertInstanceOf('Rime\ActionView\TemplateRegistry', $this->view->getLayoutRegistry());
  }
