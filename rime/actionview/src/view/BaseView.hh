...
abstract class BaseView
{
  ...
  private TemplateRegistry $view_registry;
  private TemplateRegistry $layout_registry;
  
  public function __construct(TemplateRegistry $view_registry, TemplateRegistry $layout_registry) 
  {
  ...
  public function getLayoutRegistry(): TemplateRegistry
  {
  ...
  public function getViewRegistry(): TemplateRegistry
  {
    return $this->view_registry;
  }
  
  
  protected function setTemplateRegistry(TemplateRegistry $template_registry): void
  {
