...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->factory = new \Rime\ActionDispatch\Dispatcher\Factory\RouterFactory;
    ...
    {
        $this->assertInstanceOf('\Rime\ActionDispatch\Dispatcher\Route\Route', $actual);
    }
    ...
    public function testAddAndGenerate()
    {
        ...
        // fail to match
        $this->setExpectedException('\Rime\ActionDispatch\Dispatcher\Exception\RouteNotFound');
    ...
    public function testGetAndSetRoutes()
    {
        ...
        $this->assertInstanceOf('\Rime\ActionDispatch\Dispatcher\Route\RouteCollection', $actual);
        $this->assertTrue(count($actual) == 2);
        $this->assertInstanceOf('\Rime\ActionDispatch\Dispatcher\Route\Route', $actual['page.browse']);
        $this->assertEquals('/page/', $actual['page.browse']->path);
        $this->assertInstanceOf('\Rime\ActionDispatch\Dispatcher\Route\Route', $actual['page.read']);
    ...
    public function testArrayAccess()
    {
        ...
        $this->setExpectedException('\Rime\ActionDispatch\Dispatcher\Exception\UnexpectedValue');
