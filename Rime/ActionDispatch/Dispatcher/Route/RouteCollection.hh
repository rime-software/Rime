...
class RouteCollection extends \Rime\ActionDispatch\Dispatcher\Spec\AbstractSpec implements ArrayAccess,Countable,IteratorAggregate
{
  ...
  public function __construct(\Rime\ActionDispatch\Dispatcher\Factory\RouteFactory $route_factory,array $routes = array()) 
  {
  ...
  public function offsetSet($name, $route): void
  {
    ...
    {
      throw new \Rime\ActionDispatch\Dispatcher\Exception\UnexpectedValue;
    }
  ...
  public function addGet($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
  ...
  public function addDelete($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
    $route = $this->add($name, $path);
  ...
  public function addHead($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
    $route = $this->add($name, $path);
  ...
  public function addOptions($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
    $route = $this->add($name, $path);
  ...
  public function addPatch($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
    $route = $this->add($name, $path);
  ...
  public function addPost($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
    $route = $this->add($name, $path);
  ...
  public function addPut($name, $path): \Rime\ActionDispatch\Dispatcher\Route\Route
  {
    $route = $this->add($name, $path);
    $route->addMethod('PUT');
    return $route;
  ...
  public function setRouteCallable($callable): \Rime\ActionDispatch\Dispatcher\Route\RouteCollection
  {
  ...
  public function setResourceCallable($resource): \Rime\ActionDispatch\Dispatcher\Route\RouteCollection
  {
    $this->resource_callable = $resource;
    return $this;
  }
  
  protected function resourceCallable(\Rime\ActionDispatch\Dispatcher\Route\RouteCollection $router): void
  {
